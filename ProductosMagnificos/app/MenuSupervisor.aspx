<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuSupervisor.aspx.cs" Inherits="ProductosMagnificos.app.MenuSupervisor" %>
...
<body>
    <form id="form1" runat="server">
         ...
         <asp:Label ID="lblinicio"  CssClass="titulo1" runat="server" Text="Menú Supervisor"></asp:Label>
 
    <menu>
        <li>Productos y Ordenes</li>
        <li><a href = "OrdenesEnProcesoSup.aspx">Ordenes En Proceso</a></li>
        ...
        <asp:Button ID="Btnbusqueda" CssClass="boton1" runat="server" Text="Buscar" OnClick="Btnbusqueda_Click" />
           ...
           <asp:Label ID="lblvendedor" CssClass="label1ingreso" runat="server" Text="Supervisor:"></asp:Label>
      ...
      <asp:Button ID="btnver" CssClass="boton3ingreso" runat="server" Text="Ver" OnClick="btnver_Click" />
        ...
        <asp:Button ID="btnterminar" CssClass="botonterminar" runat="server" Text="Terminar" OnClick="btnterminar_Click" />
